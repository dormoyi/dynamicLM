...
w <- 2 # Predict the 5-year outcome
...
# import stack_data.R
source("C:\\Users\\idormoy\\Documents\\dynamicLM\\R\\stack_data.R")
...
source("C:\\Users\\idormoy\\Documents\\dynamicLM\\R\\add_interactions.R")
...
####################
source("C:\\Users\\idormoy\\Documents\\dynamicLM\\R\\dynamic_lm.R")
...
source("C:\\Users\\idormoy\\Documents\\dynamicLM\\R\\plot.R")
...
source("C:\\Users\\idormoy\\Documents\\dynamicLM\\R\\predict.R")
...
preds_cox <- predict(example.cox, w = 2, newdata = lmdata_test1)
preds_pen <- predict(pen.cox, w = 2, newdata = lmdata_test1)
```
...
source("C:\\Users\\idormoy\\Documents\\dynamicLM\\R\\calplot.R")
...
source("C:\\Users\\idormoy\\Documents\\dynamicLM\\R\\score.R")
